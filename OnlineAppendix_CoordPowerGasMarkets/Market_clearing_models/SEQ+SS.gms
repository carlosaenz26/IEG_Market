...
n(i) non self-scheduling power plants /i1,i2,i3,i4,i5,i6,i7,i8,i9/
z(n) non-gas power plants /i1,i2,i3,i4,i5,i6/
g(n) gas-fired power plants /i7,i8,i9/
s(n) slow-start power plants /i1,i2,i4,i5,i6,i7,i9/
$onempty
f(n) fast-start power plants /i3,i8/
$offempty
$onempty
ss(i) self-scheduling power plants /i10/
$offempty
$onempty
ssz(ss) self-scheduling non-gas power plants / /
$offempty
$onempty
ssg(ss) self-scheduling gas-fired power plants /i10/
$offempty
...
*---------------gas day-ahead---------------------------------------------------
*-------------------------------------------------------------------------------
Gas_bal(t).. sum(k, g_DA(k,t)) - sum(g, idata(g,'phi')*p_DA(g,t)) - sum(ssg, idata(ssg,'phi')*p_DA(ssg,t)) - D_G(t) =e= 0;
*-------------------------------------------------------------------------------
...
*---------------gas real-time---------------------------------------------------
*-------------------------------------------------------------------------------
RT_Gas_balance(t,omega).. sum(k, g_RT(k,t,omega)) - sum(g, idata(g,'phi')*p_RT(g,t,omega)) - sum(ssg, idata(ssg,'phi')*p_RT(ssg,t,omega))  + l_sh_G(t,omega) =e= 0;
...
comp1(i,t).. (p_DA(i,t) - u_DA(i,t)*idata(i,'P_min')) =g= 0;
comp2(i,t).. (u_DA(i,t)*idata(i,'P_max') - p_DA(i,t)) =g= 0;
comp3(j,t).. w_DA(j,t) =g= 0;
comp4(j,t).. (Wind_DA(j,t) - w_DA(j,t)) =g= 0;
comp5(i,t)$(ord(t)>1).. [(p_DA(i,t) - p_DA(i,t-1)) + u_DA(i,t-1)*idata(i,'Ramp')] =g= 0;
comp6(i,t)$(ord(t)>1).. [u_DA(i,t)*idata(i,'Ramp') -(p_DA(i,t) - p_DA(i,t-1))] =g= 0;
comp7(i,t)$(ord(t)=1).. [(p_DA(i,t) - idata(i,'P_ini')) + idata(i,'U_ini')*idata(i,'Ramp')] =g= 0;
comp8(i,t)$(ord(t)=1).. [u_DA(i,t)*idata(i,'Ramp') - (p_DA(i,t) - idata(i,'P_ini'))] =g= 0;
...
*-------------------------------------------------------------------------------
L8_u_DAa(ss,t)$(ord(t)<card(t))..- idata(ss,'P_max')*mu_max_P(ss,t) + idata(ss,'P_min')*mu_min_P(ss,t) - idata(ss,'Ramp')*mu_max_R(ss,t) - idata(ss,'Ramp')*mu_min_R(ss,t+1) +idata(ss,'C_SU')*(mu_max_SU(ss,t) - mu_max_SU(ss,t+1)) + mu_max_B(ss,t) - mu_min_B(ss,t)+ sum(omega,  - idata(ss,'P_max')*nu_max_P(ss,t,omega) + idata(ss,'P_min')*nu_min_P(ss,t,omega)- idata(ss,'Ramp')*nu_max_R(ss,t,omega) - idata(ss,'Ramp')*nu_min_R(ss,t+1,omega) ) =e= 0;
L8_u_DAb(ss,t)$(ord(t)=card(t))..- idata(ss,'P_max')*mu_max_P(ss,t) + idata(ss,'P_min')*mu_min_P(ss,t) - idata(ss,'Ramp')*mu_max_R(ss,t) +idata(ss,'C_SU')*(mu_max_SU(ss,t)) + mu_max_B(ss,t) - mu_min_B(ss,t)+ sum(omega,  - idata(ss,'P_max')*nu_max_P(ss,t,omega) + idata(ss,'P_min')*nu_min_P(ss,t,omega)- idata(ss,'Ramp')*nu_max_R(ss,t,omega) ) =e= 0;
...
*-------------------------------------------------------------------------------
L8_p_DAa(ssz,t)$(ord(t)<card(t)).. - lambda_DA_E(t) + idata(ssz,'C_E')+ mu_max_P(ssz,t) - mu_min_P(ssz,t) + mu_max_R(ssz,t) - mu_max_R(ssz,t+1) - mu_min_R(ssz,t) + mu_min_R(ssz,t+1)+ sum(omega, [ nu_max_P(ssz,t,omega) - nu_min_P(ssz,t,omega) + nu_max_R(ssz,t,omega)- nu_max_R(ssz,t+1,omega) - nu_min_R(ssz,t,omega) + nu_min_R(ssz,t+1,omega) ]) =e= 0;
L8_p_DAb(ssz,t)$(ord(t)=card(t)).. - lambda_DA_E(t) + idata(ssz,'C_E')+ mu_max_P(ssz,t) - mu_min_P(ssz,t) + mu_max_R(ssz,t) - mu_min_R(ssz,t)+ sum(omega, [ nu_max_P(ssz,t,omega) - nu_min_P(ssz,t,omega) + nu_max_R(ssz,t,omega)- nu_min_R(ssz,t,omega) ]) =e= 0;
...
*-------------------------------------------------------------------------------
L9_p_DAa(ssg,t)$(ord(t)<card(t)).. - lambda_DA_E(t) + lambda_DA_G(t)*idata(ssg,'phi')+ mu_max_P(ssg,t) - mu_min_P(ssg,t) + mu_max_R(ssg,t) - mu_max_R(ssg,t+1) - mu_min_R(ssg,t) + mu_min_R(ssg,t+1)+ sum(omega, [ nu_max_P(ssg,t,omega) - nu_min_P(ssg,t,omega) + nu_max_R(ssg,t,omega)- nu_max_R(ssg,t+1,omega) - nu_min_R(ssg,t,omega) + nu_min_R(ssg,t+1,omega) ]) =e= 0;
L9_p_DAb(ssg,t)$(ord(t)=card(t)).. - lambda_DA_E(t) + lambda_DA_G(t)*idata(ssg,'phi')+ mu_max_P(ssg,t) - mu_min_P(ssg,t) + mu_max_R(ssg,t) - mu_min_R(ssg,t)+ sum(omega, [ nu_max_P(ssg,t,omega) - nu_min_P(ssg,t,omega) + nu_max_R(ssg,t,omega)- nu_min_R(ssg,t,omega) ]) =e= 0;
...
act_prof_DA(t)= p_DA.l('i10',t)*(lambda_DA_E.l(t) - idata('i10','phi')*lambda_DA_G.l(t)) - c_DA.l('i10',t);
act_prof_RT(t)= sum(omega, pi(omega)*p_RT.l('i10',t,omega)*((lambda_RT_E.l(t,omega)/pi(omega)) - idata('i10','phi')*(lambda_RT_G.l(t,omega)/pi(omega))));
