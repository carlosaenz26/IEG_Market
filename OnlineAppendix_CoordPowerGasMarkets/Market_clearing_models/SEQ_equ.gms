...
vbr /r1/
$onempty
r(vbr) electricity virtual bidders //
$offempty
vbq   /q1/
$onempty
q(vbq) gas virtual bidders //
$offempty
...
est_prof_DA(t)= p_DA.l('i10',t)*(lambda_DA_E.l(t) - idata('i10','phi')*exp_lambda_DA_G(t)) - c_DA.l('i10',t);
est_prof_RT(t)= sum(omega, pi(omega)*p_RT.l('i10',t,omega)*((lambda_RT_E.l(t,omega)/pi(omega)) - idata('i10','phi')*(exp_lambda_RT_G(t,omega)/pi(omega))));
